...
urlpatterns = [
    ...
    path('Profile/update', views.DONOR_PROFILE_UPDATE, name='donor-profile_update'),
    ...
    # Donor Panel
    # path('register/', views.register_user, name='register'),  # Uncomment if register_user exists in views.py
    # path('login/', views.login_user, name='login'),  # Uncomment if login_user exists in views.py
    path('donor_signup/', donorviews.DONORSIGNUP, name='donor_signup'),
